		...
		if (idUniv != null) {
			...
			if (idFakultas != null) {
				...
				if (idProdi != null) {
					...
					model.addAttribute("Message", String.format("Lihat data Mahasiswa Program Studi %s %s", namaProdiSelected, namaFakultasSelected));
					model.addAttribute("DatalistMahasiswa", tmpData);
